...
}:
{
  ...
  brave-aarch64-linux = {
    ...
    version = "1.95.102";
    src = fetchurl {
      url = "https://github.com/brave/brave-browser/releases/download/v1.95.102/brave-browser_1.95.102_arm64.deb";
      sha256 = "sha256-2S4CdU7HJ0MPUw5R2KOlEEHQ3wfWJYkHLBpNBrvwA3s=";
    };
  };
  brave-x64-linux = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-kwEQ/lfIO+Myc4ipQ+nqy87Ag6PhtLwIvsQTeIQYvf4=";
    };
  };
  discord-rpc-lsp = {
  ...
  faugus-launcher = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2.3.0";
      fetchSubmodules = false;
      sha256 = "sha256-fD4mvz4zSYzyp9MCTKjYvaYMa/Hc7IRrirnF/GNF6p8=";
    };
  };
  ...
  helix-steel = {
    pname = "helix-steel";
    version = "09d67dfe7300ab18c267e6b0cbfbb493cce21d37";
    src = fetchFromGitHub {
      owner = "mattwparas";
      repo = "helix";
      rev = "09d67dfe7300ab18c267e6b0cbfbb493cce21d37";
      fetchSubmodules = false;
      sha256 = "sha256-jA7yECKwNvq2qgfrVwmXk00GtnF5SV8yRUNUCRyUZjA=";
    };
    date = "2026-09-17";
  };
  nvfetcher = {
